...
class LMymBCartCoinManager: NSObject {
    ...
    func loadDefaultData() {
        ...
        let iapItem0 = StoreItem.init(id: 0, iapId: "com.likesquare.getpost.listone", coin: 100, price: "$0.99", color: "#FFDCEC")
        let iapItem1 = StoreItem.init(id: 1, iapId: "com.likesquare.getpost.listtwo", coin: 300, price: "$1.99", color: "#C9FFEE")
        let iapItem2 = StoreItem.init(id: 2, iapId: "com.likesquare.getpost.listthree", coin: 500, price: "$2.99", color: "#FFDCEC")
        let iapItem3 = StoreItem.init(id: 3, iapId: "com.likesquare.getpost.listfour", coin: 1000, price: "$4.99", color: "#C9FFEE")
        let iapItem4 = StoreItem.init(id: 4, iapId: "com.likesquare.getpost.listfive", coin: 2000, price: "$6.99", color: "#FFDCEC")
        let iapItem5 = StoreItem.init(id: 5, iapId: "com.likesquare.getpost.listsix", coin: 3000, price: "$8.99", color: "#C9FFEE")
        let iapItem6 = StoreItem.init(id: 6, iapId: "com.likesquare.getpost.listseven", coin: 4000, price: "$9.99", color: "#FFDCEC")
        let iapItem7 = StoreItem.init(id: 7, iapId: "com.likesquare.getpost.listeight", coin: 5000, price: "$10.99", color: "#C9FFEE")
